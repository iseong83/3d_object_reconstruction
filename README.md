...
This is an open source package to generate 3D voxels of object from 2D images. You can find the slides for this project [here][5], and a demo utilizing Streamlit app [here][0].
